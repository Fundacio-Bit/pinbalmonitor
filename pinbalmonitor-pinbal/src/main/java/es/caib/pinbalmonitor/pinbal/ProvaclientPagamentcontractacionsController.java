...
@ViewScoped
public class ProvaclientPagamentcontractacionsController implements Serializable {
    
    private static final long serialVersionUID = 1L;

    private static final Logger LOG = LoggerFactory.getLogger(ProvaclientPagamentcontractacionsController.class);

    /**
     * Injecta l'API del client del servei de verificació d'identitat
     */
    @Inject
    private ProvaclientPagamentcontractacions pinbalCCAAContractacions;
    ...
    public void correntPagament() {
        ...
        ClientSvdccaacpcws01.SolicitudSvdccaacpcws01 solicitud = new ClientSvdccaacpcws01.SolicitudSvdccaacpcws01();
        ...
        // Datos específicos
        solicitud.setCodigoProvincia(configuracio.getCodigoProvincia());
        solicitud.setCodigoComunidadAutonoma(configuracio.getCodigoComunidadAutonoma());
        try {
            resposta = pinbalCCAAContractacions.peticioSincrona(solicitud);
        } catch (Exception e) {
    ...
    public void descarregarJustificant() throws IOException {
        ...
        ScspJustificante justificant = pinbalCCAAContractacions.getJustificant(idPeticio);
