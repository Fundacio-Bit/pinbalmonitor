...
public class ClientPadroHistoricController  implements Serializable {
     ...
     */
    @Inject
    private ClientPadroHistoric ClientPadroHistoric;
    ...
    public void correntPagament() {
        LOG.info("clientPinbalPadróHistòric");
        ...
        try {
            resposta = ClientPadroHistoric.peticioSincrona(solicitud);
        } catch (Exception e) {
    ...
    public void descarregarJustificant() throws IOException {
        ...
        ScspJustificante justificant = ClientPadroHistoric.getJustificant(idPeticio);
