...
Per provar la integració amb LOGINIB:
    ...
    2. Editar els fitxers de configuració:
        - scripts/configuracio/pinbalmonitor.system.properties
        - scripts/configuracio/pinbalmonitor.properties
    ...
    3. Desplegar l'aplicació dins l'EAR
        ...
        El mòdul estarà accessible a:
            ...
            http://localhost:8080/pinbalmonitorfront
            https://localhost:8443/pinbalmonitorfront
