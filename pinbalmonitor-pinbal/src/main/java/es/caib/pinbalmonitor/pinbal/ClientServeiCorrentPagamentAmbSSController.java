...
@ViewScoped
public class ClientServeiCorrentPagamentAmbSSController implements Serializable {
     ...
     */
    @Inject
    private ClientServeiCorrentPagamentAmbSS clientPinbalSS;
    ...
    public void correntPagament() {
        LOG.info("clientPinbalSS");

        ClientQ2827003atgss001.SolicitudQ2827003atgss001 solicitud = new ClientQ2827003atgss001.SolicitudQ2827003atgss001();
        ...
        try {
            resposta = clientPinbalSS.peticioSincrona(solicitud);
        } catch (Exception e) {
    ...
    public void descarregarJustificant() throws IOException {
        ...
        ScspJustificante justificant = clientPinbalSS.getJustificant(idPeticio);
