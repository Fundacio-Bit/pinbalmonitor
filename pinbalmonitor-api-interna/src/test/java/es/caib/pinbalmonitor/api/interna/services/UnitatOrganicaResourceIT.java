...
import es.caib.pinbalmonitor.service.exception.ServiceException;
import es.caib.pinbalmonitor.service.model.EstatPublicacio;
    ...
    public static WebArchive createDeployment() {
        try {
            WebArchive war = ShrinkWrap.create(WebArchive.class, "test.war")
                    ...
                    .addPackages(false, "es.caib.pinbalmonitor.api.interna")
                    .addPackages(false, "es.caib.pinbalmonitor.api.interna.services")
                    .addPackages(true, "es.caib.pinbalmonitor.commons.rest")
                    .addPackages(true, "es.caib.pinbalmonitor.service")
                    .addPackages(true, "es.caib.pinbalmonitor.ejb")
                    .addPackages(true, "es.caib.pinbalmonitor.persistence")
                    .addAsResource(
