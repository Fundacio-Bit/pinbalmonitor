package es.caib.pinbalmonitor.pinbal.funcionamentPinbal;
...
public class ProvaClientSvdccaacpasws01Controller implements Serializable {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ProvaClientSvdccaacpasws01Controller.class);

    /**
     * Injecta l'API del client del servei de verificació d'identitat
     */
    @Inject
    private ProvaClientSvdccaacpasws01 clientPinbalCCAA;
    ...
    public void correntPagament() {
        ...
        ClientSvdccaacpasws01.SolicitudSvdccaacpasws01 solicitud = new ClientSvdccaacpasws01.SolicitudSvdccaacpasws01();
    ...
    public void descarregarJustificant() throws IOException {
        ...
        ScspJustificante justificant = clientPinbalCCAA.getJustificant(idPeticio);
