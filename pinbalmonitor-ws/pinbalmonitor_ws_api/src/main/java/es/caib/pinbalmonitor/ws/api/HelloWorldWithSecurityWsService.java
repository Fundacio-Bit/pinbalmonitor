...
@WebServiceClient(name = "HelloWorldWithSecurityWsService",
                  wsdlLocation = "http://localhost:8080/pinbalmonitor-ws-server-1.0.0/HelloWorldWithSecurityWsService/HelloWorldWithSecurityWs?wsdl",
                  targetNamespace = "http://impl.ws.pinbalmonitor.caib.es/")
public class HelloWorldWithSecurityWsService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://impl.ws.pinbalmonitor.caib.es/", "HelloWorldWithSecurityWsService");
    public final static QName HelloWorldWithSecurityWs = new QName("http://impl.ws.pinbalmonitor.caib.es/", "HelloWorldWithSecurityWs");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/pinbalmonitor-ws-server-1.0.0/HelloWorldWithSecurityWsService/HelloWorldWithSecurityWs?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldWithSecurityWsService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/pinbalmonitor-ws-server-1.0.0/HelloWorldWithSecurityWsService/HelloWorldWithSecurityWs?wsdl");
        }
        WSDL_LOCATION = url;
    }
