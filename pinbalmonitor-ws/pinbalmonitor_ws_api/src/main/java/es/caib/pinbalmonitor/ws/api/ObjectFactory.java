 ...
 * generated in the es.caib.pinbalmonitor.ws.api package. 
...
public class ObjectFactory {
    ...
    private final static QName _WsI18NError_QNAME = new QName("http://impl.ws.pinbalmonitor.caib.es/", "WsI18NError");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.caib.pinbalmonitor.ws.api
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://impl.ws.pinbalmonitor.caib.es/", name = "WsI18NError")
