 ...
 */
@Entity
@SequenceGenerator(name = "uo-sequence", sequenceName = "PBM_UNITATORGANICA_SEQ", allocationSize = 1)
@Table(name = "PBM_UNITATORGANICA",
        uniqueConstraints = {
                @UniqueConstraint(name = "PBM_UNITAT_CODIDIR3_UK", columnNames = "CODIDIR3")
        },
        indexes = {
                @Index(name = "PBM_UNITAT_PK_I", columnList = "ID"),
                @Index(name = "PBM_UNITAT_CODIDIR3_UK_I", columnList = "CODIDIR3")
        }
)
@NamedQueries({
