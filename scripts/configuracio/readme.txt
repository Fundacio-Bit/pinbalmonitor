...
amb la propietat de sistema "es.caib.pinbalmonitor.properties".
...
a dins l'apartat de <system-properties>:
    ...
    ...
    <system-properties>
        <property name="es.caib.pinbalmonitor.properties" value="/ruta/cap/al/fitxer/pinbalmonitor.properties"/>
    </system-properties>
    ...
