...
@ViewScoped
public class ProvaClientSvddgpciws02Controller implements Serializable {
     ...
     */
    @Inject
    private ProvaClientSvddgpciws02 clientSvddgpciws02;
    ...
    public void correntPagament() {
        ...
        try {
            resposta = clientSvddgpciws02.peticioSincrona(solicitud);
        } catch (Exception e) {
    ...
    public void descarregarJustificant() throws IOException {
        ...
        ScspJustificante justificant = clientSvddgpciws02.getJustificant(idPeticio);
