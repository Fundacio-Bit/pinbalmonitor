package es.caib.pinbalmonitor.ws.utils;

import es.caib.pinbalmonitor.commons.i18n.I18NException;
...
public class WsInInterceptor extends AbstractPhaseInterceptor<Message> {
    ...
    public void handleMessage(Message message) throws Fault {
        ...
        LOG.info("WsInInterceptor::handleMessage() => PBM_USER {}", context.isUserInRole(Constants.PBM_USER));
        LOG.info("WsInInterceptor::handleMessage() => PBM_ADMIN {}", context.isUserInRole(Constants.PBM_ADMIN));
    }
