 ...
 * @author areus
 */
@Named("pinbalDiscapacitatController")
@ViewScoped
public class ClientDiscapacitatController implements Serializable {
     ...
     */
    @Inject
    private ClientDiscapacitat clientDiscapacitat  ;
    ...
    public void correntPagament() {
        ...
        ClientSvdsccdws01.SolicitudSvdsccdws01 solicitud = new ClientSvdsccdws01.SolicitudSvdsccdws01();
        ...
        try {
            resposta = clientDiscapacitat.peticioSincrona(solicitud);
        } catch (Exception e) {
    ...
    public void descarregarJustificant() throws IOException {
        ...
        ScspJustificante justificant = clientDiscapacitat.getJustificant(idPeticio);
