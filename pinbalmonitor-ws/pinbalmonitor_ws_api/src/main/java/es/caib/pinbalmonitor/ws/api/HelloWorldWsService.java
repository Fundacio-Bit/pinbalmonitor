...
@WebServiceClient(name = "HelloWorldWsService",
                  wsdlLocation = "http://localhost:8080/pinbalmonitor-ws-server-1.0.0/HelloWorldWsService/HelloWorldWs?wsdl",
                  targetNamespace = "http://impl.ws.pinbalmonitor.caib.es/")
public class HelloWorldWsService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://impl.ws.pinbalmonitor.caib.es/", "HelloWorldWsService");
    public final static QName HelloWorldWs = new QName("http://impl.ws.pinbalmonitor.caib.es/", "HelloWorldWs");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/pinbalmonitor-ws-server-1.0.0/HelloWorldWsService/HelloWorldWs?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldWsService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/pinbalmonitor-ws-server-1.0.0/HelloWorldWsService/HelloWorldWs?wsdl");
        }
        WSDL_LOCATION = url;
    }
