...
public class ServeiVerificacioIdentitatController implements Serializable {
    ...
    private ClientSvddgpviws02 clientSvddgpviws02 = new ClientSvddgpviws02(
    ...
    public String verificarIdentitat() {
        ...
        try {
            resposta = clientSvddgpviws02.peticionSincrona(Arrays.asList(solicitud));
            ...
            Gson gson = new Gson();
            return ("No funciona: " /*+ gson.toJsonTree(solicitud)*/);
        }
