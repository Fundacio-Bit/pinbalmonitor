...
import es.caib.pinbalmonitor.ejb.converter.UnitatOrganicaConverter;
...
import es.caib.pinbalmonitor.persistence.model.UnitatOrganica;
import es.caib.pinbalmonitor.service.exception.RecursNoTrobatException;
import es.caib.pinbalmonitor.service.exception.UnitatDuplicadaException;
import es.caib.pinbalmonitor.service.exception.UnitatTeProcedimentsException;
import es.caib.pinbalmonitor.service.facade.UnitatOrganicaServiceFacade;
import es.caib.pinbalmonitor.service.model.AtributUnitat;
import es.caib.pinbalmonitor.service.model.Ordre;
import es.caib.pinbalmonitor.service.model.Pagina;
import es.caib.pinbalmonitor.service.model.UnitatOrganicaDTO;
